// Generated by Bisonc++ V6.01.03 on Wed, 04 Apr 2018 19:39:34 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {259, 2}, // 1: lines ->  lines line
     {259, 1}, // 2: lines ->  line
     {260, 2}, // 3: line ('\x0a') ->  expr '\x0a'
     {261, 1}, // 4: expr (NUMBER) ->  NUMBER
     {261, 2}, // 5: expr ('-') ->  '-' expr
     {261, 3}, // 6: expr ('+') ->  expr '+' expr
     {261, 3}, // 7: expr ('*') ->  expr '*' expr
     {261, 3}, // 8: expr (INEQ) ->  expr INEQ expr
     {261, 3}, // 9: expr ('^') ->  expr '^' expr
     {262, 1}, // 10: lines_$ ->  lines
};
...
#line 51 "grammar"
        {
         d_val__ = (vs__(-2) != vs__(0)) ? true : false;
         }
        break;
