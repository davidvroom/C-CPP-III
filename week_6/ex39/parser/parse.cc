// Generated by Bisonc++ V6.01.03 on Wed, 04 Apr 2018 19:29:48 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {258, 2}, // 1: lines ->  lines line
     {258, 1}, // 2: lines ->  line
     {259, 2}, // 3: line ('\x0a') ->  expr '\x0a'
     {260, 1}, // 4: expr (NR) ->  NR
     {260, 2}, // 5: expr ('-') ->  '-' expr
     {260, 3}, // 6: expr ('+') ->  expr '+' expr
     {260, 3}, // 7: expr ('-') ->  expr '-' expr
     {260, 3}, // 8: expr ('*') ->  expr '*' expr
     {260, 3}, // 9: expr ('/') ->  expr '/' expr
     {260, 2}, // 10: expr ('$') ->  '$' expr
     {260, 3}, // 11: expr ('(') ->  '(' expr ')'
     {261, 1}, // 12: lines_$ ->  lines
};
