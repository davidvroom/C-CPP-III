// Generated by Bisonc++ V6.01.03 on Wed, 04 Apr 2018 16:23:41 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {260, 4}, // 5: token ('[') ->  token '[' NR_or_VAR ']'
     {260, 1}, // 6: token ->  NR_or_VAR
     {261, 1}, // 7: NR_or_VAR (NR) ->  NR
     {261, 1}, // 8: NR_or_VAR (VAR) ->  VAR
     {262, 1}, // 9: expr_$ ->  expr
};
