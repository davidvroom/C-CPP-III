// Generated by Bisonc++ V6.01.03 on Mon, 09 Apr 2018 15:47:34 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {276, 2}, // 4: line (errTok__) ->  errTok__ '\x0a'
     {276, 1}, // 5: line ('\x0a') ->  '\x0a'
     {276, 2}, // 6: line (RAD) ->  RAD '\x0a'
     {276, 2}, // 7: line (DEG) ->  DEG '\x0a'
     {276, 2}, // 8: line (GRAD) ->  GRAD '\x0a'
     {277, 1}, // 9: expr (NUMBER) ->  NUMBER
     {277, 1}, // 10: expr (EULER) ->  EULER
     {277, 1}, // 11: expr (PI) ->  PI
     {277, 1}, // 12: expr (IDENT) ->  IDENT
     {277, 2}, // 13: expr (uMinus) ->  '-' expr
     {277, 3}, // 14: expr ('+') ->  expr '+' expr
     {277, 3}, // 15: expr ('-') ->  expr '-' expr
     {277, 3}, // 16: expr ('(') ->  '(' expr ')'
     {277, 3}, // 17: expr ('=') ->  expr '=' expr
     {277, 4}, // 18: expr (EXP) ->  EXP '(' expr ')'
     {277, 4}, // 19: expr (LN) ->  LN '(' expr ')'
     {277, 4}, // 20: expr (SIN) ->  SIN '(' expr ')'
     {277, 4}, // 21: expr (ASIN) ->  ASIN '(' expr ')'
     {277, 4}, // 22: expr (COS) ->  COS '(' expr ')'
     {277, 4}, // 23: expr (ACOS) ->  ACOS '(' expr ')'
     {277, 4}, // 24: expr (TAN) ->  TAN '(' expr ')'
     {277, 4}, // 25: expr (ATAN) ->  ATAN '(' expr ')'
     {277, 4}, // 26: expr (SQRT) ->  SQRT '(' expr ')'
     {277, 4}, // 27: expr (ABS) ->  ABS '(' expr ')'
     {278, 1}, // 28: lines_$ ->  lines
};
