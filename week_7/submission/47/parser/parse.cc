// Generated by Bisonc++ V6.01.03 on Mon, 09 Apr 2018 13:55:51 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {260, 2}, // 1: lines ->  lines line
     {260, 1}, // 2: lines ->  line
     {261, 2}, // 3: line ('\x0a') ->  expr '\x0a'
     {261, 1}, // 4: line ('\x0a') ->  '\x0a'
     {261, 2}, // 5: line (errTok__) ->  errTok__ '\x0a'
     {262, 1}, // 6: expr (NUMBER) ->  NUMBER
     {262, 3}, // 7: expr ('+') ->  expr '+' expr
     {262, 3}, // 8: expr ('-') ->  expr '-' expr
     {262, 3}, // 9: expr ('*') ->  expr '*' expr
     {262, 3}, // 10: expr ('/') ->  expr '/' expr
     {262, 2}, // 11: expr (UMINUS) ->  '-' expr
     {263, 1}, // 12: lines_$ ->  lines
};
...
#line 47 "grammar"
        {
         d_val__ = vs__(-2).get<Tag__::DOUBLE>() * vs__(0).get<Tag__::DOUBLE>();
         }
        break;
...
#line 67 "grammar"
        {
         d_val__ = -vs__(0).get<Tag__::DOUBLE>(); 
         }
        break;
