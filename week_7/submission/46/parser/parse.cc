// Generated by Bisonc++ V6.01.03 on Mon, 09 Apr 2018 23:46:21 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {274, 3}, // 15: expr (ADDASSIGN) ->  expr ADDASSIGN expr
     {274, 3}, // 16: expr (SUBASSIGN) ->  expr SUBASSIGN expr
     {274, 3}, // 17: expr (MULASSIGN) ->  expr MULASSIGN expr
     {274, 3}, // 18: expr (DIVASSIGN) ->  expr DIVASSIGN expr
     {274, 3}, // 19: expr ('%') ->  expr '%' expr
     {274, 3}, // 20: expr (LSHIFT) ->  expr LSHIFT expr
     {274, 3}, // 21: expr (RSHIFT) ->  expr RSHIFT expr
     {274, 3}, // 22: expr ('&') ->  expr '&' expr
     {274, 3}, // 23: expr ('|') ->  expr '|' expr
     {274, 3}, // 24: expr ('^') ->  expr '^' expr
     {274, 2}, // 25: expr ('~') ->  '~' expr
