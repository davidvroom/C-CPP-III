// Generated by Bisonc++ V6.01.03 on Fri, 06 Apr 2018 16:06:42 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {274, 2}, // 1: lines ->  lines line
     {274, 1}, // 2: lines ->  line
     {275, 2}, // 3: line ('\x0a') ->  expr '\x0a'
     {275, 2}, // 4: line (errTok__) ->  errTok__ '\x0a'
     {275, 1}, // 5: line ('\x0a') ->  '\x0a'
     {275, 2}, // 6: line (LIST) ->  LIST '\x0a'
     {276, 1}, // 7: expr (NUMBER) ->  NUMBER
     {276, 1}, // 8: expr (IDENT) ->  IDENT
     {276, 1}, // 9: expr (STOP) ->  STOP
     {276, 2}, // 10: expr (uMinus) ->  '-' expr
     {276, 3}, // 11: expr ('+') ->  expr '+' expr
     {276, 3}, // 12: expr ('-') ->  expr '-' expr
     {276, 3}, // 13: expr ('*') ->  expr '*' expr
     {276, 3}, // 14: expr ('/') ->  expr '/' expr
     {276, 3}, // 15: expr ('(') ->  '(' expr ')'
     {276, 3}, // 16: expr ('=') ->  expr '=' expr
     {276, 3}, // 17: expr (ADDASSIGN) ->  expr ADDASSIGN expr
     {276, 3}, // 18: expr (SUBASSIGN) ->  expr SUBASSIGN expr
     {276, 3}, // 19: expr (MULASSIGN) ->  expr MULASSIGN expr
     {276, 3}, // 20: expr (DIVASSIGN) ->  expr DIVASSIGN expr
     {276, 3}, // 21: expr ('%') ->  expr '%' expr
     {276, 3}, // 22: expr (LSHIFT) ->  expr LSHIFT expr
     {276, 3}, // 23: expr (RSHIFT) ->  expr RSHIFT expr
     {276, 3}, // 24: expr ('&') ->  expr '&' expr
     {276, 3}, // 25: expr ('|') ->  expr '|' expr
     {276, 3}, // 26: expr ('^') ->  expr '^' expr
     {276, 2}, // 27: expr ('~') ->  '~' expr
     {276, 3}, // 28: expr (MODASSIGN) ->  expr MODASSIGN expr
     {276, 3}, // 29: expr (LSHIFTASSIGN) ->  expr LSHIFTASSIGN expr
     {276, 3}, // 30: expr (RSHIFTASSIGN) ->  expr RSHIFTASSIGN expr
     {276, 3}, // 31: expr (ANDASSIGN) ->  expr ANDASSIGN expr
     {276, 3}, // 32: expr (XORASSIGN) ->  expr XORASSIGN expr
     {276, 3}, // 33: expr (ORASSIGN) ->  expr ORASSIGN expr
     {277, 1}, // 34: lines_$ ->  lines
};
...
#line 126 "grammar"
        {
         d_val__ = addAssign(vs__(-2), vs__(0));
         }
        break;
...
#line 131 "grammar"
        {
         d_val__ = subAssign(vs__(-2), vs__(0)); 
         }
        break;
...
#line 136 "grammar"
        {
         d_val__ = mulAssign(vs__(-2), vs__(0)); 
         }
        break;
...
#line 141 "grammar"
        {
         d_val__ = divAssign(vs__(-2), vs__(0));
         }
        break;
...
#line 181 "grammar"
        {
         d_val__ = modAssign(vs__(-2), vs__(0));
         }
        break;
...
#line 186 "grammar"
        {
         d_val__ = lShiftAssign(vs__(-2), vs__(0));
         }
        break;
...
#line 191 "grammar"
        {
         d_val__ = rShiftAssign(vs__(-2), vs__(0));
         }
        break;
...
#line 196 "grammar"
        {
         d_val__ = andAssign(vs__(-2), vs__(0));
         }
        break;
...
#line 201 "grammar"
        {
         d_val__ = xOrAssign(vs__(-2), vs__(0));
         }
        break;
...
#line 206 "grammar"
        {
         d_val__ = orAssign(vs__(-2), vs__(0));
         }
        break;
