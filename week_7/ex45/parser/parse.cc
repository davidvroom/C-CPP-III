// Generated by Bisonc++ V6.01.03 on Fri, 06 Apr 2018 13:21:27 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {263, 2}, // 4: line (errTok__) ->  errTok__ '\x0a'
     {263, 1}, // 5: line ('\x0a') ->  '\x0a'
     {263, 2}, // 6: line (LIST) ->  LIST '\x0a'
     {264, 1}, // 7: expr (NUMBER) ->  NUMBER
     {264, 1}, // 8: expr (IDENT) ->  IDENT
     {264, 1}, // 9: expr (STOP) ->  STOP
     {264, 2}, // 10: expr (uMinus) ->  '-' expr
     {264, 3}, // 11: expr ('+') ->  expr '+' expr
     {264, 3}, // 12: expr ('-') ->  expr '-' expr
     {264, 3}, // 13: expr ('(') ->  '(' expr ')'
     {264, 3}, // 14: expr ('=') ->  expr '=' expr
     {265, 1}, // 15: lines_$ ->  lines
};
