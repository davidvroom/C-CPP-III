// Generated by Bisonc++ V6.01.03 on Wed, 11 Apr 2018 22:38:02 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {268, 1}, // 2: lines ->  line
     {269, 2}, // 3: line ('\x0a') ->  expr '\x0a'
     {269, 2}, // 4: line (errTok__) ->  errTok__ '\x0a'
     {269, 1}, // 5: line ('\x0a') ->  '\x0a'
     {269, 2}, // 6: line (RAD) ->  RAD '\x0a'
     {269, 2}, // 7: line (DEG) ->  DEG '\x0a'
     {269, 2}, // 8: line (GRAD) ->  GRAD '\x0a'
     {270, 1}, // 9: expr (NUMBER) ->  NUMBER
     {270, 1}, // 10: expr (EULER) ->  EULER
     {270, 1}, // 11: expr (PI) ->  PI
     {270, 1}, // 12: expr (IDENT) ->  IDENT
     {270, 2}, // 13: expr (uMinus) ->  '-' expr
     {270, 3}, // 14: expr ('+') ->  expr '+' expr
     {270, 3}, // 15: expr ('-') ->  expr '-' expr
     {270, 3}, // 16: expr ('(') ->  '(' expr ')'
     {270, 3}, // 17: expr ('=') ->  expr '=' expr
     {270, 4}, // 18: expr ('(') ->  function '(' expr ')'
     {271, 1}, // 19: function (FUNCTION) ->  FUNCTION
     {272, 1}, // 20: lines_$ ->  lines
};
...
#line 41 "grammar"
        {
         display(vs__(-1).get<Tag__::RULEVALUE>());
         }
        break;
...
#line 79 "grammar"
        {
         d_val__ = setValue(2.71828182845904523536);
         }
        break;
...
#line 84 "grammar"
        {
         d_val__ = setValue(3.14159265358979323846);
         }
        break;
...
#line 94 "grammar"
        {
         d_val__ = negate(vs__(0).get<Tag__::RULEVALUE>());
         }
        break;
...
#line 99 "grammar"
        {
         d_val__ = add(vs__(-2).get<Tag__::RULEVALUE>(), vs__(0).get<Tag__::RULEVALUE>());
         }
        break;
...
#line 104 "grammar"
        {
         d_val__ = sub(vs__(-2).get<Tag__::RULEVALUE>(), vs__(0).get<Tag__::RULEVALUE>());
         }
        break;
...
#line 110 "grammar"
        {
         d_val__ = vs__(-1).get<Tag__::RULEVALUE>();
         }
        break;
...
#line 115 "grammar"
        {
         d_val__ = assign(vs__(-2).get<Tag__::RULEVALUE>(), vs__(0).get<Tag__::RULEVALUE>());
         }
        break;
...
#line 120 "grammar"
        {
         d_val__ = callFunction(vs__(-3).get<Tag__::FUNC>(), vs__(-1).get<Tag__::RULEVALUE>());
         }
        break;
